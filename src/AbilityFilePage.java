...
import javax.swing.*;
public class AbilityFilePage extends JFrame{
    ...
    private AbilityFileController vac;
...
public AbilityFilePage(String c){
    super("Ability File Page");
    cnp=c;
    p=new JPanel();
    vac=new AbilityFileController();
    vac.setCNP(c);
    ...
    if(AbilityFileManager.countIDS(cnp))
       {String s=AbilityFileManager.displayIDs(cnp);
